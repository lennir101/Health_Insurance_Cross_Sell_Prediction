...
import ApiService, { DataStats, ModelMetrics } from '@/services/api';
        ...
        <TabsContent value="overview" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{dataStats?.total_records.toLocaleString() || 0}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{((modelMetrics?.accuracy || 0) * 100).toFixed(2)}%</div>
        ...
        <TabsContent value="features" className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">此區域將顯示特徵間的相關性分析</p>
                <div className="h-48 flex items-center justify-center border rounded-md bg-slate-50">
                  <p className="text-sm text-slate-500">相關性矩陣圖 (開發中)</p>
                </div>
              </CardContent>
            </Card>
            <Card>
