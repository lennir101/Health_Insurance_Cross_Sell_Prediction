...
const Dashboard: React.FC = () => {
    ...
    const [thresholdAnalysis, setThresholdAnalysis] = useState<Array<{
        threshold: number;
        precision: number;
        recall: number;
        f1: number
                            ...
                            <CardContent>
                                <ResponsiveContainer width="100%" height={300}>
                                    <LineChart data={prepareAgeGroupStats()}>
                                        ...
                                        <Tooltip/>
                                        <Legend/>
                                        <Line yAxisId="left" type="monotone" dataKey="avgPremium" stroke="#8884d8"
                                              name="平均保費"/>
                                        <Line yAxisId="right" type="monotone" dataKey="responseRate" stroke="#82ca9d"
                                              name="響應率 (%)"/>
                                    </LineChart>
                                </ResponsiveContainer>
                            </CardContent>
