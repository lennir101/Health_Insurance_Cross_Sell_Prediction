...
class ProductionConfig:
    ...
    MODEL_PATH = os.environ.get("MODEL_PATH", 
                               os.path.join(os.path.abspath(os.path.dirname(__file__)), '..', 'ml_models/final_model.joblib'))
    LABEL_ENCODERS_PATH = os.environ.get("LABEL_ENCODERS_PATH",
                                        os.path.join(os.path.abspath(os.path.dirname(__file__)), '..', 'ml_models/label_encoders.joblib'))
